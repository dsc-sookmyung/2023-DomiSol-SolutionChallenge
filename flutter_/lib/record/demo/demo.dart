...
*/
  ...
  AssetImage recorderAssetImage() {
    if (onStartRecorderPressed() == null) {
      return AssetImage('images/ic_mic_disabled.png');
    }
    return (recorderModule.isStopped)
        ? AssetImage('images/ic_mic.png')
        : AssetImage('images/ic_stop.png');
  }
